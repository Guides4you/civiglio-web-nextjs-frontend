...
/**
 * AppLayout - Modern layout for authenticated app area
 *
 * Features:
    ...
    <div id="wrapper" className="listeo">
      ...
      <style jsx>{`
        ...
        .app-sidebar {
          ...
          z-index: 50; /* Lower than header (which is 1000+) */
          overflow-y: auto;
          display: none;
        }
        ...
        .mobile-sidebar-toggle {
          ...
          z-index: 500; /* Below header but above content */
          display: flex;
          align-items: center;
          justify-content: center;
          transition: all 0.3s ease;
        ...
        .mobile-sidebar-overlay {
          ...
          z-index: 800; /* Below header (1000+) but above content */
          opacity: 0;
          visibility: hidden;
          transition: all 0.3s ease;
        }
        ...
        .mobile-sidebar {
          ...
          overflow-y: auto;
          z-index: 900; /* Below header (1000+) but above overlay */
          display: block;
        }
        ...
        .app-content {
          flex: 1;
          padding: 104px 24px 40px 24px; /* Top padding for header, bottom for spacing */
          margin-left: 0;
